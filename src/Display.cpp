...
Adafruit_SH1106G display = Adafruit_SH1106G(DISPLAY_WIDTH, DISPLAY_HEIGHT, &SPI1, OLED_DC, OLED_RST, OLED_CS);

int8_t display_page = 0;
uint8_t key_brightness = DEFAULT_BRIGHTNESS;
uint8_t display_contrast = DEFAULT_BRIGHTNESS;
bool auto_clear_display = true;
